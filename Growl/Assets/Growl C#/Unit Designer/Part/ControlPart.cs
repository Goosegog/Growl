...
public class ControlPart : Part
{
    ...
    public override void Init()
    {
        ...
        part_type = PartType.ControlPart;
    ...
    void CheckEnergySupply()
    {
        ...
        ////////////        {
        ////////////            //只要与本零件相连的所有零件中任意一个的 energy_supply 为true，自己就也是true；
        ////////////            energy_supply = true;
        ////////////            return;
        ////////////        }
        ////////////    }
        ...
        ////////////}
        //////////////遍历完了还没有return出去，说明这个零件现在 energy_supply 应该为 false：
        ////////////energy_supply = false;
        //==========================================================================================================================
    ...
    private void OnTriggerExit(Collider other)
    {
        ...
        else if (other.gameObject.layer == 12)
        {
            if (!overlaped_parts.Contains(other.GetComponent<Part>()))
            {
                ...
                Debug.LogError("严重错误：物体退出了碰撞但碰撞列表里却没有相应物体，退出碰撞.name = " + other.name);
